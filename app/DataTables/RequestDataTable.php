...
class RequestDataTable extends DataTable
{
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('id'),
            Column::make('patient_unique_id')->title('Patient Unique ID'),
            Column::make('patient_name')->title('Patient Name'),
            Column::make('preferred_visit_date')->title('Preferred Visit Date'),
            Column::make('preferred_time_slot')->title('Preferred Time Slot'),
