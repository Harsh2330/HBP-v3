...
<head>
    ...
    <style>
        .scroll-button {
            ...
            background-color:rgb(78, 19, 255);
            border: none;
            padding: 10px;
            cursor: pointer;
            z-index: 10;
...
<body>
    ...
    <section class="services">
        ...
        <a href="{{ route('services.service1') }}" class="service-box">
            <div class="service">
        ...
        <a href="{{ route('services.service2') }}" class="service-box">
            <div class="service">
                <div class="service-image"></div>
        ...
        <a href="{{ route('services.service3') }}" class="service-box">
            <div class="service">
                <div class="service-image"></div>
        ...
        <a href="{{ route('services.service4') }}" class="service-box">
            <div class="service">
                <div class="service-image"></div>
        ...
        <a href="{{ route('services.service5') }}" class="service-box">
            <div class="service">
                <div class="service-image"></div>
