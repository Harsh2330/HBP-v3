...
<body>
    <div class="container mx-auto bg-white p-8 shadow-lg rounded-lg mt-12">
        ...
        <p class="text-lg mb-2"><strong class="highlight font-semibold text-green-500">User ID:</strong> {{ $userId }}</p>
        <p class="text-lg mb-2"><strong class="highlight font-semibold text-green-500">Email:</strong> {{ $email }}</p>
        <p class="text-lg mb-2"><strong class="highlight font-semibold text-green-500">Password:</strong> {{ $password }}</p>
